...
export default function ProfileScreen() {
  ...
  const handleRoleSwitch = () => {
    ...
    const newRole = user.role === "maker" ? "buyer" : "maker";
    ...
    if (Platform.OS === "web") {
      ...
      Alert.alert("Sign Out", "Are you sure you want to sign out?", [
        { text: "Cancel", style: "cancel" },
        {
          text: "Sign Out",
          style: "destructive",
          onPress: () => { setUser(null); router.replace("/onboarding"); },
        },
      ]);
    }
  };
  ...
  return (
    ...
    >
      ...
      <View style={styles.section}>
        ...
        >
          ...
          <View style={styles.menuLabel}>
            <Text style={styles.menuTitle}>
              Switch to {user.role === "maker" ? "Buyer" : "Maker"}
            </Text>
            <Text style={styles.menuSubtitle}>
              {user.role === "maker"
                ? "Browse and claim listings"
                : "Post your surplus produce"}
            </Text>
          </View>
        ...
        <Pressable
          onPress={() => { Haptics.selectionAsync(); Alert.alert("Credits", "You start with 20 credits. Earn more by posting listings and having them claimed. Each claimed item earns you the listed credit value."); }}
          style={({ pressed }) => [styles.menuItem, { opacity: pressed ? 0.85 : 1 }]}
        >
          <View style={[styles.menuIcon, { backgroundColor: C.tint + "18" }]}>
      ...
      <View style={styles.section}>
        ...
        <Pressable
          onPress={() => { Haptics.selectionAsync(); Alert.alert("About HarvestSwap", "A rural food-swap network connecting makers and buyers in your community. Version 1.0"); }}
          style={({ pressed }) => [styles.menuItem, { opacity: pressed ? 0.85 : 1 }]}
        >
          ...
          <View style={styles.menuLabel}>
            ...
            <Text style={styles.menuSubtitle}>Version 1.0</Text>
          </View>
          <Feather name="chevron-right" size={16} color={C.textMuted} />
        </Pressable>
